...
class ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate{
    ...
    override func viewDidLoad() {
        ...
        mascotas.append(compra(nombre: "teporingo", precio: 569.9, descripcion: "casero",imagen:"teporingo"))
        mascotas.append(compra(nombre: "coco", precio: 566.89, descripcion: "jdjdj",imagen:"coco"))
